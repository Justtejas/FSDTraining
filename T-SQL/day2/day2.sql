...
-- Primary key in the table will automatically create an clustered index.
-- we can create only 1 clustered index
-- normal index (non-unique,non-clustered)
-- we can create 999 non-clustered indexes
-- if we have duplicate values or null values it'll sort them and store the data
